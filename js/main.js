...
function Draw0(){
    ...
    changeText("Here we have WASP-12 b, one of the biggest satellites in our dataset. " +
    ...
    changeText("As a note, although the sizes of the planet are scaled, and the orbits are scaled, " +
        "they are not scaled to each other. Otherwise most satellites would become smaller than " +
...
function Draw2() {
    ...
    //Dim all satellites again
    dim(delayTime = 0);
    //Make satellites bigger again
    d3.selectAll(".planet")
...
function Draw3(){
    ...
    changeText("The satellites you see here are quite different from Earth because of more reasons. " +
        "The average time it takes these 288 satellites to go around their star is only 17 Earth days! ",
        delayDisappear = 0, delayAppear = 1);
...
function Draw4(){
    ...
    changeText("Both of the satellites highlighted now are on very circular orbits. " +
    ...
    changeText("If the eccentricity is close to 0, the ellipse is more like a circle, " +
        "like our satellites here. However, if the eccentricity is close to 1, " +
...
function Draw6() {
    ...
    //Return satellites to original speed
    speedUp = 100000;
    ...
    changeText("Wondering about the color of the satellites? They are colored according to " +
    ...
    changeText("You can hover over the legend in the bottom right to highlight only satellites " +
...
d3.select("#crazy")
    .on("click", function(e) {
        ...
        //Bring all satellites back to initial opacity
        bringBack(opacity = planetOpacity);

        //Bring color to the satellites
        svg.selectAll(".planet")
